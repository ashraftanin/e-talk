...
public class Seekcorrectsentence extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_seekcorrectsentence);
		Button nextToHome;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.seekcorrectsentence, menu);
		return true;
	}
