...
public class Oderinginaresturant extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_oderinginaresturant);
		Button nextToHome;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.oderinginaresturant, menu);
		return true;
	}
